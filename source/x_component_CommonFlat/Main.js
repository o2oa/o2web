MWF.xApplication.CommonFlat = MWF.xApplication.CommonFlat || {
	options: {
...
(function () {
	...
	Events.implement({
		"fireEvent": function (type, args, delay) {
			if (this.options && this.options.name && o2.xDesktop && o2.xDesktop.$globalEvents) {
...
MWF.xApplication.Common.Main = new Class({
	...
	loadWindow: function (isCurrent, animation, max, hide) {
		...
		this.window.content = new Element("div.layout_component_content").inject(layout.desktop.contentAreaNode);
