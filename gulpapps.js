var dev = [
    ...
    { "folder": "x_component_Chat", "tasks": ["move", "min"] },
    ...
    { "folder": "x_component_OnlineMeeting", "tasks": ["move", "min"] },
    { "folder": "x_component_OnlineMeetingRoom", "tasks": ["move", "min"] },
    ...
    { "folder": "x_component_process_ApplicationExplorer1", "tasks": ["move", "min"] },
    ...
    { "folder": "x_component_process_Xform2", "tasks": ["move", "min"] },
    ...
    { "folder": "x_component_ScriptEditor", "tasks": ["move", "min"] },
    { "folder": "x_component_Search", "tasks": ["move", "min"] },
    { "folder": "x_component_SelecterTest", "tasks": ["move", "min"] },
    ...
    { "folder": "x_component_SmartOfficeRoom", "tasks": ["move", "min"] },
    { "folder": "x_component_Snake", "tasks": ["move", "min"] },
